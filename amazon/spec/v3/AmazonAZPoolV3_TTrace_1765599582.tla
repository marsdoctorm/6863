---- MODULE AmazonAZPoolV3_TTrace_1765599582 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("AmazonAZPoolV3_TTrace_1765599582.json", _TETrace)
...
\*
\*trace == IODeserialize("AmazonAZPoolV3_TTrace_1765599582.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG AmazonAZPoolV3_TTrace_1765599582 ----
CONSTANTS
    UseBad = TRUE
    RetryLimit = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Dec 12 23:19:42 EST 2025