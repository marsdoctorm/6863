---- MODULE AmazonTraceValidator_TTrace_1765582324 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("AmazonTraceValidator_TTrace_1765582324.json", _TETrace)
...
\*
\*trace == IODeserialize("AmazonTraceValidator_TTrace_1765582324.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG AmazonTraceValidator_TTrace_1765582324 ----
CONSTANTS
    UseBad = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Dec 12 18:32:05 EST 2025