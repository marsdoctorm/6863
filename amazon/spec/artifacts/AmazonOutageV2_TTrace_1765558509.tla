---- MODULE AmazonOutageV2_TTrace_1765558509 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("AmazonOutageV2_TTrace_1765558509.json", _TETrace)
...
\*
\*trace == IODeserialize("AmazonOutageV2_TTrace_1765558509.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG AmazonOutageV2_TTrace_1765558509 ----
CONSTANTS
    UseBad = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Dec 12 11:55:10 EST 2025