---- MODULE AmazonTraceValidator_TTrace_1765557446 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("AmazonTraceValidator_TTrace_1765557446.json", _TETrace)
...
\*
\*trace == IODeserialize("AmazonTraceValidator_TTrace_1765557446.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG AmazonTraceValidator_TTrace_1765557446 ----
CONSTANTS
    UseBad = TRUE
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Dec 12 11:37:27 EST 2025