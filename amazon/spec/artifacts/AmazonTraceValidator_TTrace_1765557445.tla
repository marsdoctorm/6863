---- MODULE AmazonTraceValidator_TTrace_1765557445 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("AmazonTraceValidator_TTrace_1765557445.json", _TETrace)
...
\*
\*trace == IODeserialize("AmazonTraceValidator_TTrace_1765557445.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([healthy |-> {},inst |-> {},pool |-> {},i |-> 1]),
    ([healthy |-> {},inst |-> {"i1"},pool |-> {},i |-> 2]),
    ([healthy |-> {"i1"},inst |-> {"i1"},pool |-> {},i |-> 3]),
    ([healthy |-> {"i1"},inst |-> {"i1"},pool |-> {"i1"},i |-> 4]),
    ([healthy |-> {},inst |-> {"i1"},pool |-> {},i |-> 5]),
    ([healthy |-> {},inst |-> {"i1"},pool |-> {},i |-> 6]),
    ([healthy |-> {},inst |-> {},pool |-> {},i |-> 7])
    >>
----
...
---- CONFIG AmazonTraceValidator_TTrace_1765557445 ----
CONSTANTS
    UseBad = FALSE
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Dec 12 11:37:26 EST 2025